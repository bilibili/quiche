...
#include "gquiche/quic/core/frames/quic_max_streams_frame.h"
...
#include "gquiche/quic/core/quic_blocked_writer_interface.h"
#include "gquiche/quic/core/quic_connection_context.h"
#include "gquiche/quic/core/quic_connection_id.h"
#include "gquiche/quic/core/quic_connection_id_manager.h"
...
#include "gquiche/quic/core/quic_idle_network_detector.h"
#include "gquiche/quic/core/quic_mtu_discovery.h"
#include "gquiche/quic/core/quic_network_blackhole_detector.h"
...
#include "gquiche/quic/core/quic_ping_manager.h"
#include "gquiche/quic/core/quic_sent_packet_manager.h"
#include "gquiche/quic/core/quic_time.h"
#include "gquiche/quic/core/quic_types.h"
#include "gquiche/quic/core/uber_received_packet_manager.h"
...
class QUIC_EXPORT_PRIVATE QuicConnectionVisitorInterface {
 public:
  ...
  virtual void OnAckFrameStart(QuicTime::Delta ack_delay_time) {}

  // Called when ack_range in ack frame has been parsed.
  virtual void OnAckRange(QuicPacketNumber start, QuicPacketNumber end) {}

  // Done processing ack frame.
  virtual void OnAckFrameEnd(QuicPacketNumber start) {}
