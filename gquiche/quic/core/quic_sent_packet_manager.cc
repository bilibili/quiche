...
#include "gquiche/quic/core/congestion_control/general_loss_algorithm.h"
#include "gquiche/quic/core/congestion_control/pacing_sender.h"
...
void QuicSentPacketManager::SetSendAlgorithm(
  ...
  SetSendAlgorithm(SendAlgorithmInterface::Create(
      ...
      stats_, initial_congestion_window_, send_algorithm_.get(), extra_loss_threshold_));
}
